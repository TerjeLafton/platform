...
// ErrorResponse is shared across all services
type ErrorResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Code          string                 `protobuf:"bytes,1,opt,name=code,proto3" json:"code,omitempty"`       // e.g., "VALIDATION_ERROR", "NOT_FOUND", "AUTH_ERROR", "INTERNAL_ERROR"
...
const file_common_v1_common_proto_rawDesc = "" +
	...
	"\amessage\x18\x02 \x01(\tR\amessageB<Z:github.com/terjelafton/platform/libs/proto-stubs/common/v1b\x06proto3"
